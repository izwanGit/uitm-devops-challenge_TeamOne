...
class PaymentsService {
    ...
    async processPayment(invoiceId, paymentData, userId) {
        ...
        if (paymentAmount < invoiceAmount) {
            throw new Error(`Payment amount (${paymentAmount}) is less than invoice amount (${invoiceAmount})`);
        }
    ...
    async getPaymentsForInvoice(invoiceId, userId) {
        ...
        if (invoice.lease.tenantId !== userId && invoice.lease.landlordId !== userId) {
            throw new Error('Access denied');
        }
